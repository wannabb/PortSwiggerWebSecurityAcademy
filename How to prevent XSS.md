...
: CSP는 XSS 공격에 대한 최후의 방어선으로써 앞의 방어 수단이 우회되었을 경우, 공격자가 할 수 있는 행동을 제한함으로써 그 피해를 줄일 수 있다. [CSP](https://github.com/wannabb/PortSwiggerWebSecurityAcademy/edit/main/CSP.md)
